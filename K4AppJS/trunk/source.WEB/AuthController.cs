...
namespace K4AppJS
{
	public class AuthController:ApiController
	{
		...
		{
			return Request.CreateResponse(HttpStatusCode.OK, "a42b1b07-59c5-44ee-9b00-199e0ae3d940");
		}
		[HttpPost]
		public  HttpResponseMessage Get (GetAuthenticationDataObj getAuthenticationDataObj)
		{
			...
			applicationLoginEntries.LoginFormEntries.TitleEntry = HttpUtility.HtmlDecode("Sign into your K4AppJS account");
