'use strict'
var kamApp = angular.module('K4AppJS', ['ngResource','ngRoute','ngCookies','angular-md5','ngAnimate','oc.lazyLoad','ui.router','ui.utils','ui.select','ui.bootstrap','ngSanitize','K4AppJSModuleBsn','mentio']);
...
kamApp.directive('kam4menu',function()
{
	return {
	    ...
	    templateUrl: 'AbstractMenu.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
...
kamApp.directive('kam4controlscontainer',['$route','$q',function($route,$q)
{
	return {
	    restrict: 'A',
	    templateUrl: 'ControlsContainer.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
	    link: function (scope, element, attrs) {
	        ...
	        case 'traduzioni.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940':
	            event.currentScope.menu.setMenuList([1], [{ name: 'MenuHeaderMain', contextLevel: 1, position: 'top' }
	         ]);
	         break;
	        case 'lingue.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940':
	            event.currentScope.menu.setMenuList([1], [{ name: 'MenuHeaderMain', contextLevel: 1, position: 'top' }
	         ]);
	         break;
	        case 'diario.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940':
	            event.currentScope.menu.setMenuList([1], [{ name: 'MenuHeaderMain', contextLevel: 1, position: 'top' }
	         ]);
	         break;
	        case 'logout.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940':
	            event.currentScope.menu.setMenuList([1], [{ name: 'MenuHeaderMain', contextLevel: 1, position: 'top' }
	         ]);
	         break;
	        case 'index.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940':
	            event.currentScope.menu.setMenuList([1], [{ name: 'MenuHeaderMain', contextLevel: 1, position: 'top' }
	         ]);
	         break;
	        case 'stringhe.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940':
	            event.currentScope.menu.setMenuList([1], [{ name: 'MenuHeaderMain', contextLevel: 1, position: 'top' }
	         ]);
	         break;
	                }
...
kamApp.directive('commandPopup',function()
{
	return {
	    restrict: 'E',
	    replace: false,
	    templateUrl: 'CommandPopup.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940'
	};
}
);
...
.when('/Traduzioni', {
    templateUrl: 'Traduzioni.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load({ files: ['Traduzioni.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','BusinessPages/Traduzioni.bsn.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','MenuHeaderMain.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940'] });
        }],
...
.when('/Index', {
    templateUrl: 'Index.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load({ files: ['Index.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','BusinessPages/Index.bsn.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','MenuHeaderMain.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940'] });
        }],
        loadGlobalData: function(GlobalEntriesFactory, GlobalSettingsFactory, LoggedUserSettingsFactory, LoginService) {
            if(!GlobalEntriesFactory.LoadedFromServer || !GlobalSettingsFactory.LoadedFromServer || !LoggedUserSettingsFactory.LoadedFromServer) {
                return LoginService.getGlobalData().then(function (result){
...
.when('/Diario', {
    templateUrl: 'Diario.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load({ files: ['Diario.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','BusinessPages/Diario.bsn.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','MenuHeaderMain.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940'] });
        }],
        loadGlobalData: function(GlobalEntriesFactory, GlobalSettingsFactory, LoggedUserSettingsFactory, LoginService) {
            if(!GlobalEntriesFactory.LoadedFromServer || !GlobalSettingsFactory.LoadedFromServer || !LoggedUserSettingsFactory.LoadedFromServer) {
                return LoginService.getGlobalData().then(function (result){
...
.when('/Lingue', {
    templateUrl: 'Lingue.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load({ files: ['Lingue.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','BusinessPages/Lingue.bsn.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','MenuHeaderMain.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940'] });
        }],
        loadGlobalData: function(GlobalEntriesFactory, GlobalSettingsFactory, LoggedUserSettingsFactory, LoginService) {
            if(!GlobalEntriesFactory.LoadedFromServer || !GlobalSettingsFactory.LoadedFromServer || !LoggedUserSettingsFactory.LoadedFromServer) {
                return LoginService.getGlobalData().then(function (result){
...
.when('/LogOut', {
    templateUrl: 'LogOut.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load({ files: ['LogOut.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','BusinessPages/LogOut.bsn.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','MenuHeaderMain.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940'] });
        }],
        loadGlobalData: function(GlobalEntriesFactory, GlobalSettingsFactory, LoggedUserSettingsFactory, LoginService) {
            if(!GlobalEntriesFactory.LoadedFromServer || !GlobalSettingsFactory.LoadedFromServer || !LoggedUserSettingsFactory.LoadedFromServer) {
                return LoginService.getGlobalData().then(function (result){
...
.when('/Stringhe', {
    templateUrl: 'Stringhe.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load({ files: ['Stringhe.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','BusinessPages/Stringhe.bsn.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940','MenuHeaderMain.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940'] });
        }],
        loadGlobalData: function(GlobalEntriesFactory, GlobalSettingsFactory, LoggedUserSettingsFactory, LoginService) {
            if(!GlobalEntriesFactory.LoadedFromServer || !GlobalSettingsFactory.LoadedFromServer || !LoggedUserSettingsFactory.LoadedFromServer) {
                return LoginService.getGlobalData().then(function (result){
...
.when('/NavigationLandingPage', {
    templateUrl: 'NavigationLandingPage.html?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940',
    resolve: {
        loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load({ files: ['NavigationLandingPage.ng.js?version=a42b1b07-59c5-44ee-9b00-199e0ae3d940'] });
        }],
        loadGlobalData: function(GlobalEntriesFactory, GlobalSettingsFactory, LoggedUserSettingsFactory, LoginService) {
            if(!GlobalEntriesFactory.LoadedFromServer || !GlobalSettingsFactory.LoadedFromServer || !LoggedUserSettingsFactory.LoadedFromServer) {
                return LoginService.getGlobalData().then(function (result){
