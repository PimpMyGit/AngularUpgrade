...
[assembly: PreApplicationStartMethod(typeof(K4AppJS.SwaggerConfig), "Register")]
namespace K4AppJS
{
	public class SwaggerConfig
	{
	    ...
	    {
	        return System.String.Format(@"{0}\bin\K4AppJS.xml", System.AppDomain.CurrentDomain.BaseDirectory);
	    }
